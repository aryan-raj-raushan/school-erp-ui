...
import { MobileSettingsNav } from "@/components/ui/mobile-settings-nav";
    ...
    <div className="flex min-h-screen flex-col md:flex-row">
      {!isIndex && (
        ...
        <aside className="hidden md:flex flex-col w-56 shrink-0 border-r border-border bg-card h-screen sticky top-0">
          ...
          <Nav padding="py-3">
            <SectionLabel padding="px-3 mb-2">Settings</SectionLabel>
      ...
      <main className={`flex-1  overflow-y-auto p-2 md:p-8 ${!isIndex ? " max-w-6xl" : ""}`}>
        {children}
      </main>
    </div>
  );
