...
function GradingFormContent({ slug }: { slug: string }) {
...
function GradingSlugContent() {
  const params = useParams();
  const slug = Array.isArray(params.slug) ? params.slug[0] : params.slug ?? "create-new";
  return <GradingFormContent slug={slug} />;
}

export default function GradingSlugPage() {
  return (
