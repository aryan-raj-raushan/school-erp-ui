        ...
        <Div type="col" gap="md" className="max-w-2xl">
          ...
          <Div type="grid" cols={2} gap="md">
            ...
            <FormField label={CLASSES_PAGE.form.classSequence} error={form.formState.errors.class_sequence?.message}>
              <Select {...form.register('class_sequence')} defaultValue="">
          ...
          <Div type="grid" cols={2} gap="md">
            <FormField label={CLASSES_PAGE.form.noOfSessions} error={form.formState.errors.no_of_sessions?.message}>
              <Input type="number" min={1} placeholder={CLASSES_PAGE.placeholders.noOfSessions} {...form.register('no_of_sessions')} />
            </FormField>
          ...
          <Div type="row" gap="md">
            ...
            <Button type="submit" loading={isSubmitting}>{CLASSES_PAGE.form.submit}</Button>
          </Div>
        </Div>
      </form>
    </Div>
