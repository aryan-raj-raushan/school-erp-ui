...
function EditClassDetailPageInner() {
  ...
  return (
    <Div type="col" gap="lg">
      <PageHeader
        title={CLASS_DETAILS_PAGE.form.editTitle}
        subtitle="Update class detail configuration"
      ...
      <form onSubmit={handleSubmit}>
        <Div type="col" gap="md" className="max-w-2xl">
          ...
          <Div type="row" gap="md">
            ...
            <Button type="submit" loading={isSubmitting}>{CLASS_DETAILS_PAGE.form.update}</Button>
          </Div>
        </Div>
      </form>
    </Div>
...
export default function EditClassDetailPage() {
  return (
