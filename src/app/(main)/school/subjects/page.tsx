  ...
  return (
    <Div type="col" gap="lg">
      <PageHeader
        ...
        actions={<Button onClick={navigateToNew}>{SUBJECTS_PAGE.addButton}</Button>}
      />
      ...
      <Table>
        <TableHead>
          <TableHeadRow>
            ...
            <TableHeaderCell>{SUBJECTS_PAGE.table.displayOrder}</TableHeaderCell>
            <TableHeaderCell>{SUBJECTS_PAGE.table.totalMarks}</TableHeaderCell>
            <TableHeaderCell>{SUBJECTS_PAGE.table.passingMarks}</TableHeaderCell>
          ...
          {isLoading ? (
            ...
            subjects.map((subject) => (
              <TableRow key={subject.id}>
                ...
                <TableCell>
                  <Div type="row" gap="xs">
                    <Button size="sm" variant="ghost" onClick={() => navigateToEdit(subject.id)}>
                      <Icon icon={Pencil} type="sm" />
                    </Button>
                    <Button size="sm" variant="ghost" onClick={() => removeSubject(subject.id)}>
