      ...
      <Div type="col" gap="md">
        ...
        <Table>
          <TableHead>
            <TableHeadRow>
              <TableHeaderCell>
                {STUDENT_DETAIL_PAGE.documentsTable.fileName}
              </TableHeaderCell>
              <TableHeaderCell>
                {STUDENT_DETAIL_PAGE.documentsTable.type}
              </TableHeaderCell>
              <TableHeaderCell>
                {STUDENT_DETAIL_PAGE.documentsTable.actions}
              </TableHeaderCell>
            </TableHeadRow>
          </TableHead>
          <TableBody>
              ...
              <Div type="col" gap="md">
                ...
                <Div type="row" gap="sm">
                  ...
                  <FormField
                    label={STUDENT_DETAIL_PAGE.parentForm.phone}
                    error={
                      editParentForm.formState.errors.phone_number?.message
                    }
                  >
                    <Input
                      type="tel"
            ...
            <ModalBody>
              <Div type="col" gap="md">
                ...
                <FormField label={STUDENT_DETAIL_PAGE.documentForm.file}>
                  <FileInput ref={fileInputRef} type="file" required />
                </FormField>
              </Div>
            </ModalBody>
            <ModalFooter>
