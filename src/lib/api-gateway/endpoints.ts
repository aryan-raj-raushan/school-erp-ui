export const ENDPOINTS = {
  ...
  homework: {
    ...
    studentSubmission: (hwId: string, studentId: string) => `/homework/${hwId}/submissions/${studentId}`,
  ...
  leave: {
    ...
    policyTypes: (leaveTypeId: string) => `/leave/policies/types/${leaveTypeId}`,
    ...
    parentStudentSummary: (studentId: string) => `/leave/parent/student/${studentId}/summary`,
  },
  exams: {
    list: '/exams',
