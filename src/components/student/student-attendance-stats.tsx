...
/**
 * Attendance summary + quick "mark all" / save actions for the Student
 * Attendance page. On mobile everything stays on a single row: compact
 * "T:8 P:3 A:5" stats on the left, icon-only action buttons on the right.
 * From sm+ the stats expand into labeled tiles and actions show text.
 */
    ...
    >
      ...
      <Div type="row" align="center" gap="xs" className="shrink-0 sm:hidden">
        <Button
          ...
          aria-label={STUDENT_ATTENDANCE_PAGE.markAllPresent}
          title={STUDENT_ATTENDANCE_PAGE.markAllPresent}
        ...
        <Button
          ...
          aria-label={STUDENT_ATTENDANCE_PAGE.markAllAbsent}
          title={STUDENT_ATTENDANCE_PAGE.markAllAbsent}
        ...
        <Button
          ...
          aria-label={STUDENT_ATTENDANCE_PAGE.save}
          title={STUDENT_ATTENDANCE_PAGE.save}
        >
          <Save />
        </Button>
      </Div>
